...
void
SpinelNCPInstance::add_service_on_ncp(uint32_t enterprise_number, 
...
void
SpinelNCPInstance::remove_service_on_ncp(uint32_t enterprise_number, const uint8_t *service_data, 
